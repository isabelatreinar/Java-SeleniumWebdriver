...
public class FormularioCadastroBaseLegalP {
	...
	//construtor
	public FormularioCadastroBaseLegalP(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void preencherCadastro() throws InterruptedException, AWTException {
		...
		FormularioCadastroTipoBaseP tipoBaseLegal = new FormularioCadastroTipoBaseP(driver);
