...
public class PreenchimentoCadastroTipoBase {
	...
	private final String opcaoAssSecretario = "Sim";
	private final String opcaoAssBeneficiario = "Sim";
	private final String opcaoAssEntidade = "Sim";
	private final String textDescricao = "Teste";

	public PreenchimentoCadastroTipoBase(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void preencherCadastro() throws InterruptedException {
		...
		// TODO CONTINUAR MUDANDO NOME DAS CONSTANTES
