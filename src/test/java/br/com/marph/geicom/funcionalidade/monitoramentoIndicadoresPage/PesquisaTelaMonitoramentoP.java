...
public class PesquisaTelaMonitoramentoP {

	private static final String FILTRO_UNIDADE_REGIONAL = ".//*[@id='comboUnidadeRegionalPesquisa_chosen']/ul/li/input";
	...
	private final String numResolucao = "1235";
	private final String modelo = "Primeiro";
	private final String periodo = "01/01/2016";
	private final String descrUnidade = "BELO HORIZONTE";

	// construtor
	public PesquisaTelaMonitoramentoP(WebDriver driver) {
		this.driver = driver;
	}
...
//		seleniumUtil.sendKeysXpath(driver, FILTRO_UNIDADE_REGIONAL, descrUnidade);
