...
import br.com.marph.geicom.funcionalidade.tipoBaseLegal.PreenchimentoCadastroTipoBase;
import br.com.marph.geicom.util.SeleniumUtil;

public class PreenchimentoCadastroBaseLegal {
	...
	private final String numeroBase = "1606";
	private final String anoVig = "2016";
	private final String dtPublic = "01012016";
	

	//construtor
	public PreenchimentoCadastroBaseLegal(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void preencherCadastro() throws InterruptedException, AWTException {
		...
		PreenchimentoCadastroTipoBase tipoBaseLegal = new PreenchimentoCadastroTipoBase(driver);
