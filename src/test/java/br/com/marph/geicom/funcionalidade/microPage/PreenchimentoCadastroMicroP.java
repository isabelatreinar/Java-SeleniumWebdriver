...
public class PreenchimentoCadastroMicroP {
	...
	private static PreenchimentoCadastroMacroP macro;
	
	public PreenchimentoCadastroMicroP(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void preencherCadastro(){
		...
		macro = new PreenchimentoCadastroMacroP(driver);
