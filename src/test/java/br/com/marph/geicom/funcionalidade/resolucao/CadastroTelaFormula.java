...
public class CadastroTelaFormula {
	...
	public void cadastrarFormula() throws InterruptedException{
		...
		//instanciar a classe CadastroTelaIndicador para usar a variável 'nome' (nome do indicador) para validação no assertEquals
		CadastroTelaIndicador indicador = new CadastroTelaIndicador(driver);
				
		//Validação para saber se o cadastro está correto, se o indicador apresentado após o cadastro tem o mesmo nome inserido no cadastro
